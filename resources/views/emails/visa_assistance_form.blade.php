...
<head>
    ...
    <style>
        ...
        .header {
            background-color: #2C3E50; /* Deep blue-gray header */
        ...
        .content p strong {
            color: #000; /* Warm orange for labels */
        }
        .footer {
            background-color: #2C3E50; /* Light footer background */
            text-align: center;
            padding: 20px;
            font-size: 14px;
            color: #888888; /* Soft gray text */
        }
        .footer a {
            color: #ffb400; /* Orange link color */
...
<body>
    <div class="container">
        <!-- Header Section -->
        <div class="header">
            <h2>Visa Assistance Form Submission</h2>
        </div>
