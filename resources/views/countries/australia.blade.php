...
@php
    ...
    $cards = [
        ...
        ['title' => '3. Post-Study Work Opportunities ', 'desc' => 'One of the biggest advantages for students post-studying in Australia is a post-study work visa. It helps students in understanding the practical aspect of their studies, and post-studying, they are given the studying in Australia for international students to work in their related field where they get very good experience of working in their field. Eventually, they will broaden their chances of getting jobs and will help in creating pathways to add on knowledge for lifetime career growth.'],
        ...
        ['title' => '6. Economically Stable and Innovation-Oriented Industries ', 'desc' => 'A stable economy, with industries that have made great strides in innovation and technology, adds to job opportunities for post study work visa in Australia graduates after they complete their studies. This also works on the concept that makes Australia one of the most desirable places to study. '],
    ...
    <div class="column-container">
        <div class="column">
            ...
            <div class="content-box">
                ...
                <p class="content-description">There are excellent job opportunities in Australia for international graduates, mostly because of Australia's strength in the economy as well as its skill- and merit-based industries. International Australia student visa step by step process who will complete their degree or course from universities in Australia might be able to apply for the Post-Study Work visa (Subclass 485) under which the eligible applicants would be allowed to stay and work in Australia up to 2 to 4 years. Fresh graduates can join any of the big jobs in the industries like IT, healthcare, engineering, business, and education.</p>
                <p class="content-description">All Australian universities strongly partner with industries to prepare internships and networking opportunities for students to secure jobs. Australia also has a Skilled Occupation List (SOL), which is known work while studying in Australia for its in-demand professions that would generally lead to permanent residency. WTS Visa Consultancy can assist students in understanding the work visa possibilities available in Australia, job search strategies, and pathways to permanent residence in Australia.</p>
            </div>
        </div>
        <div class="column">
     ...
     @php
        $faqs = [
            ...
            [
                ...
                "answer" => "Yes, graduated students may apply for the Post-Study Work Visa (Subclass 485), which allows them to remain in Australia for a time period of 2 to 4 years. If they fulfil specific requirements, they may also look into options to obtain permanent residency (PR) through the General Skilled Migration (GSM) program."
            ],
        ];
    @endphp
    <x-faq :faqs="$faqs" />
