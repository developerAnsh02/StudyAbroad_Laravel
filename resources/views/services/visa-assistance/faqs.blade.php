...
$faqs = [
    ...
    ['question' => '2. How Long Does the Visa Application Process Take?', 'answer' => 'Processing times vary by visa type and country. Tourist and business visas take weeks, while student and work visas can take months. Expedited processing is available for some countries. We\'ll keep track of your application, handle follow-ups and help you navigate any delays to get you through the process as smoothly and quickly as possible.'],
    ['question' => '3. What Documents Are Required for a Visa Application?', 'answer' => 'You\'ll need a valid passport, visa application form, passport photos, financial proof and travel details. Student visas require an acceptance letter, while work visas need job offers and sponsorship details. We\'ll give you a tailored document checklist to prevent errors and avoid delays or rejections.'],
